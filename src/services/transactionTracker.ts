...
export class TransactionTracker {
  ...
  private static finalStatuses = ['approved', 'declined', 'rejected', 'failed', 'completed'];
   ...
   */
  private static isFinalStatus(status: string | null | undefined): boolean {
   ...
   */
  static waitForWebhook(transactionId: string, timeoutMs: number = 60000): Promise<any> {
